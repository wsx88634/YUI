...
- 2026-07-27：完成 TripTree V29 本行程專屬景點夾模式、📍景點與⚡行程動作節點拆分、動態地區標籤融合、全域 link-to-triptree 工作流 Skill 技能註冊與全螢幕美化排版。
...
- [x] 完成 TripTree V29 本行程專屬景點夾模式、📍景點/⚡行程動作拆分與全域 link-to-triptree 工作流 Skill
- [ ] 依需要擴充與維護各項小工具專案
